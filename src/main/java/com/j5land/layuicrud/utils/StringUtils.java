...
public class StringUtils extends org.apache.commons.lang3.StringUtils
{
    ...
    public static String concatTimeRange(String time){
        if (isEmpty(time)) return time;
        return String.valueOf(time.charAt(0))+String.valueOf(time.charAt(1))+":"+ String.valueOf(time.charAt(2))+String.valueOf(time.charAt(3))+":"+"00";
    }
    public static String concatTimeRangeV2(String time){
        if (isEmpty(time)) return time;
        return String.valueOf(time.charAt(0))+String.valueOf(time.charAt(1))+":"+ String.valueOf(time.charAt(2))+String.valueOf(time.charAt(3));
    }
}